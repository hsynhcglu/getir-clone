    ...
    return (
        <div className='w-full bg-primary-color'>
            <div className='container mx-auto h-11 flex justify-between'>
                <a href='#' className='hover:bg-color-hover h-full items-center flex p-4 rounded-t-lg transition-all'>
                ...
                <nav className='flex gap-x-8 text-white text-sm font-semibold'>
                    <a href='#' className='flex items-center gap-x-1 hover:text-secondary-color transition-all'>
                    ...
                    <a href='#' className='flex items-center gap-x-2 hover:text-secondary-color transition-all'>
